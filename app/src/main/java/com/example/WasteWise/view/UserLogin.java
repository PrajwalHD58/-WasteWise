...
import com.example.WasteWise.model.UserData;
import com.example.WasteWise.view.MainActivity;
import com.example.WasteWise.view.SplashActivity;
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
                                    ...
                                    if (password_check.equals(password_Id_curr)) {
                                        ...
                                        SplashActivity.setUsername(username);
